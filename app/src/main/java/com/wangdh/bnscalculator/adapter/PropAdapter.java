 ...
 * 描述:  <br>
 */
public class PropAdapter extends CommonAdapter<ZBType> {
    public PropAdapter(Context context, List<ZBType> datas, int layoutId) {
        super(context, datas, layoutId);
    }
    private TextView text1 ;
    @Override
    public void convert(ViewHolder holder, ZBType zbType) {
